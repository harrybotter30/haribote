...
CSRCS = bootpack.c dsctbl.c graphic.c int.c keyboard.c mouse.c fifo.c startup.c tinylib.c
PSRCS = $(ASRCS:.S=.s)
...
$(SYS): $(OBJS) hankaku.txt asmhead.lds hrb.lds support/makefont
	...
	$(LD) $(LDFLAGS) -T hrb.lds -o bootpack.hrb bootpack.o dsctbl.o graphic.o int.o keyboard.o mouse.o fifo.o naskfunc.o tinylib.o
